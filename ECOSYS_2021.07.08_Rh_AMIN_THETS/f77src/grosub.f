...
C
      ...
      WTRT1N(N,L,NR,NZ,NY,NX)=AMAX1(0.0
     2,WTRT1N(N,L,NR,NZ,NY,NX)+GRTWTN*FGROL)
      WTRT1P(N,L,NR,NZ,NY,NX)=AMAX1(0.0
     2,WTRT1P(N,L,NR,NZ,NY,NX)+GRTWTP*FGROL)
      WSRTL(N,L,NZ,NY,NX)=WSRTL(N,L,NZ,NY,NX)
     2+AMIN1(CNWS(NZ,NY,NX)*WTRT1N(N,L,NR,NZ,NY,NX)
     2,CPWS(NZ,NY,NX)*WTRT1P(N,L,NR,NZ,NY,NX))
      RTLG1(N,L,NR,NZ,NY,NX)=AMAX1(0.0
     2,RTLG1(N,L,NR,NZ,NY,NX)+GRTLGL*FGROL)
C
