...
C
      ZNH4S(L,NY,NX)=AMAX1(0.0
     2,CN4U(L,NY,NX)*VOLW(L,NY,NX)*VLNH4(L,NY,NX)*14.0)
      ZNH4B(L,NY,NX)=AMAX1(0.0
     2,CN4U(L,NY,NX)*VOLW(L,NY,NX)*VLNHB(L,NY,NX)*14.0)
      ZNH3S(L,NY,NX)=CN3U(L,NY,NX)*VOLW(L,NY,NX)*VLNH4(L,NY,NX)*14.0
      ZNH3B(L,NY,NX)=CN3U(L,NY,NX)*VOLW(L,NY,NX)*VLNHB(L,NY,NX)*14.0
      ZNO3S(L,NY,NX)=AMAX1(0.0
     2,CNOU(L,NY,NX)*VOLW(L,NY,NX)*VLNO3(L,NY,NX)*14.0)
      ZNO3B(L,NY,NX)=AMAX1(0.0
     2,CNOU(L,NY,NX)*VOLW(L,NY,NX)*VLNOB(L,NY,NX)*14.0)
      H2PO4(L,NY,NX)=AMAX1(0.0
     2,CH2PU(L,NY,NX)*VOLW(L,NY,NX)*VLPO4(L,NY,NX)*31.0)
      H2POB(L,NY,NX)=AMAX1(0.0
     2,CH2PU(L,NY,NX)*VOLW(L,NY,NX)*VLPOB(L,NY,NX)*31.0)
      H1PO4(L,NY,NX)=AMAX1(0.0
     2,CH1PU(L,NY,NX)*VOLW(L,NY,NX)*VLPO4(L,NY,NX)*31.0)
      H1POB(L,NY,NX)=AMAX1(0.0
     2,CH1PU(L,NY,NX)*VOLW(L,NY,NX)*VLPOB(L,NY,NX)*31.0)
      ZNO2S(L,NY,NX)=0.0
      ZNO2B(L,NY,NX)=0.0
...
C
      XN4(L,NY,NX)=AMAX1(0.0,XN41*BKVL(L,NY,NX)*VLNH4(L,NY,NX))
      XNB(L,NY,NX)=AMAX1(0.0,XN41*BKVL(L,NY,NX)*VLNHB(L,NY,NX))
      ...
      XH1P(L,NY,NX)=AMAX1(0.0,XH1P1*BKVL(L,NY,NX)*VLPO4(L,NY,NX))
      XH2P(L,NY,NX)=AMAX1(0.0,XH2P1*BKVL(L,NY,NX)*VLPO4(L,NY,NX))
      ...
      XH1PB(L,NY,NX)=AMAX1(0.0,XH1P1*BKVL(L,NY,NX)*VLPOB(L,NY,NX))
      XH2PB(L,NY,NX)=AMAX1(0.0,XH2P1*BKVL(L,NY,NX)*VLPOB(L,NY,NX))
C
...
C
      ...
      CSTR(L,NY,NX)=0.0
      CION(L,NY,NX)=0.0
      ZNH4S(L,NY,NX)=AMAX1(0.0,ZNH4S(L,NY,NX)+0.5*OSN(1,2,L,NY,NX))
