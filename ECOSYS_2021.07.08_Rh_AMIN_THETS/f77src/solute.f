...
C
      ...
      VLNH4(L,NY,NX)=1.0
      VLNHB(L,NY,NX)=0.0
      ZNH4S(L,NY,NX)=AMAX1(0.0,ZNH4S(L,NY,NX)+ZNH4B(L,NY,NX))
      ZNH3S(L,NY,NX)=ZNH3S(L,NY,NX)+ZNH3B(L,NY,NX)
      ZNH4B(L,NY,NX)=0.0
      ZNH3B(L,NY,NX)=0.0
      XN4(L,NY,NX)=AMAX1(0.0,XN4(L,NY,NX)+XNB(L,NY,NX))
      XNB(L,NY,NX)=0.0
      ENDIF
      ENDIF
C
...
C
      ...
      VLNO3(L,NY,NX)=1.0
      VLNOB(L,NY,NX)=0.0
      ZNO3S(L,NY,NX)=AMAX1(0.0,ZNO3S(L,NY,NX)+ZNO3B(L,NY,NX))
      ZNO2S(L,NY,NX)=AMAX1(0.0,ZNO2S(L,NY,NX)+ZNO2B(L,NY,NX))
      ZNO3B(L,NY,NX)=0.0
      ZNO2B(L,NY,NX)=0.0
      ENDIF
      ENDIF
...
C
      ...
      H1PO4(L,NY,NX)=AMAX1(0.0,H1PO4(L,NY,NX)+H1POB(L,NY,NX))
      H2PO4(L,NY,NX)=AMAX1(0.0,H2PO4(L,NY,NX)+H2POB(L,NY,NX))
      ...
      XH1P(L,NY,NX)=AMAX1(0.0,XH1P(L,NY,NX)+XH1PB(L,NY,NX))
      XH2P(L,NY,NX)=AMAX1(0.0,XH2P(L,NY,NX)+XH2PB(L,NY,NX))
      XOH0B(L,NY,NX)=0.0
      XOH1B(L,NY,NX)=0.0
      XOH2B(L,NY,NX)=0.0
      XH1PB(L,NY,NX)=0.0
