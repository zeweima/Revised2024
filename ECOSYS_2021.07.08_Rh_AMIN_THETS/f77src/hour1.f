...
C    2,VOLWH(L,NY,NX)+VOLIH(L,NY,NX))
      VOLA(L,NY,NX)=AMAX1(0.0,POROS(L,NY,NX)*VOLY(L,NY,NX))
      VOLAH(L,NY,NX)=AMAX1(0.0,FHOL(L,NY,NX)*VOLT(L,NY,NX))
      IF(BKDS(L,NY,NX).GT.ZERO)THEN
...
C
     ...
     2*DPNHB(L,NY,NX)/DLYR(3,L,NY,NX))
      ...
      ZNH4S(L,NY,NX)=AMAX1(0.0,ZNH4T*VLNH4(L,NY,NX))
      ZNH3S(L,NY,NX)=ZNH3T*VLNH4(L,NY,NX)
      ZNH4B(L,NY,NX)=AMAX1(0.0,ZNH4T*VLNHB(L,NY,NX))
      ZNH3B(L,NY,NX)=ZNH3T*VLNHB(L,NY,NX)
      XN4(L,NY,NX)=AMAX1(0.0,XN4T*VLNH4(L,NY,NX))
      XNB(L,NY,NX)=AMAX1(0.0,XN4T*VLNHB(L,NY,NX))
50    CONTINUE
...
C
     ...
     2*DPNOB(L,NY,NX)/DLYR(3,L,NY,NX))
      ...
      ZNO3S(L,NY,NX)=AMAX1(0.0,ZNO3T*VLNO3(L,NY,NX))
      ZNO2S(L,NY,NX)=AMAX1(0.0,ZNO2T*VLNO3(L,NY,NX))
      ZNO3B(L,NY,NX)=AMAX1(0.0,ZNO3T*VLNOB(L,NY,NX))
      ZNO2B(L,NY,NX)=AMAX1(0.0,ZNO2T*VLNOB(L,NY,NX))
45    CONTINUE
...
C
     ...
     2*DPPOB(L,NY,NX)/DLYR(3,L,NY,NX))
      ...
      H1PO4(L,NY,NX)=AMAX1(0.0,H1PO4T*VLPO4(L,NY,NX))
      H2PO4(L,NY,NX)=AMAX1(0.0,H2PO4T*VLPO4(L,NY,NX))
      ...
      H1POB(L,NY,NX)=AMAX1(0.0,H1PO4T*VLPOB(L,NY,NX))
      H2POB(L,NY,NX)=AMAX1(0.0,H2PO4T*VLPOB(L,NY,NX))
      ...
      XH1P(L,NY,NX)=AMAX1(0.0,XH1PT*VLPO4(L,NY,NX))
      XH2P(L,NY,NX)=AMAX1(0.0,XH2PT*VLPO4(L,NY,NX))
      XOH0B(L,NY,NX)=XOH0T*VLPOB(L,NY,NX)
      XOH1B(L,NY,NX)=XOH1T*VLPOB(L,NY,NX)
      XOH2B(L,NY,NX)=XOH2T*VLPOB(L,NY,NX)
      XH1PB(L,NY,NX)=AMAX1(0.0,XH1PT*VLPOB(L,NY,NX))
      XH2PB(L,NY,NX)=AMAX1(0.0,XH2PT*VLPOB(L,NY,NX))
