# 1 "/projects/bbkc/hutx2309/Ecosys_Version/src/ECOSYS_2021.07.08_modified/f77src/nitro.f"
...
C
     ...
     2,DCKX(0:4),DOSX(0:4),DOSM(0:4),TGROMC(0:7)
C
...
C      DATA DOSA/0.025E-03,0.025,0.025,0.025,0.025/
...
C
     ...
     2AND.BKVL(0,NY,NX).GT.ZEROS(NY,NX))THEN
...
C
     ...
     2+ZNO3S(L,NY,NX)+ZNO2S(L,NY,NX))
      ...
      ZNH4S(L,NY,NX)=AMAX1(0.0,(1.0-DCORPC)*ZNH4S(L,NY,NX))
      ZNH3S(L,NY,NX)=(1.0-DCORPC)*ZNH3S(L,NY,NX)
      ZNO3S(L,NY,NX)=AMAX1(0.0,(1.0-DCORPC)*ZNO3S(L,NY,NX))
      ZNO2S(L,NY,NX)=AMAX1(0.0,(1.0-DCORPC)*ZNO2S(L,NY,NX))
      H1PO4(L,NY,NX)=AMAX1(0.0,(1.0-DCORPC)*H1PO4(L,NY,NX))
      H2PO4(L,NY,NX)=AMAX1(0.0,(1.0-DCORPC)*H2PO4(L,NY,NX))
      XN4(L,NY,NX)=AMAX1(0.0,(1.0-DCORPC)*XN4(L,NY,NX))
